...
drop ormoth
drop mrace
recode mrace6 (1=1) (2=2) (3=3) (4=3), generate(mrace) /*To be consistent with earlier years*/
...
foreach var in rf_diabetes rf_chyper rf_phyper rf_eclamp{
	label values `var' yesno
	}
...
gen revision=2003
replace revision=1989 if meduc==.
