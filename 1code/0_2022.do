...
merge m:1 postal_code using "state identifiers.dta", keep(1 3) nogen keepusing(fips_code state_name)
...
drop ormoth
recode mrace6 (1=1) (2=2) (3 4 5 6=3), generate(mrace) /*To be consistent with earlier years*/
